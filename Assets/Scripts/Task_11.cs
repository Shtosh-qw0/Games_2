...
public class Task_11 : MonoBehaviour
{
    ...
    public void Click_Task11()
    {
        coord_frame_1 = GameObject.Find("frame_1").transform.position;
        coord_exp_1 = GameObject.Find("exp1").transform.position;
        
        coord_frame_2 = GameObject.Find("frame_2").transform.position;
        coord_exp_2 = GameObject.Find("exp4").transform.position;

        coord_frame_3 = GameObject.Find("frame_3").transform.position;
        coord_exp_3 = GameObject.Find("exp8").transform.position;

        if (coord_frame_1 == coord_exp_1 && coord_frame_2 == coord_exp_2 && coord_frame_3 == coord_exp_3)
        {
            Debug.Log("Правильно");
