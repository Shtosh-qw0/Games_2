...
public class Task_20 : MonoBehaviour
{
    ...
    public void Click_Task20()
    {
        string userInput1 = InWord1.text.Replace(" ", "");
        string userInput2 = InWord2.text.Replace(" ", "");

        if (userInput1 == "i%2==0" && userInput2 == "a[i]")
        {
            if (!InWord1.text.Contains("=="))
            {
        ...
        else if (userInput1 == "i%2==0" && userInput2 == "a[i]")
        {
            Debug.Log("Правильно");
            gb = GameObject.Find("Next");
            gb.GetComponent<Button>().interactable = true;
