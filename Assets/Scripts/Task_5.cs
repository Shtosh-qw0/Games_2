...
public class Task_5 : MonoBehaviour
{
    ...
    //[SerializeField] private Text WhateverTextNegative;
    ...
    public void CheckingInputWord()
    {
        ...
        if (userInput1 == "(num2/100)%10" && userInput2 == "num4%10")
        {
            if (!InWord1.text.Contains("num2") || !InWord1.text.Contains("100") || !InWord1.text.Contains("10") 
                || !InWord2.text.Contains("num4") || !InWord2.text.Contains("10"))
            {
